 ...
 **               Context Hooks
 *=============================================**/
import { getDeviceClass } from "../Utils/CapabilityProbe/useCapabilityProbe";
...
export const WALLPAPER_CONFIGS = {
    ...
    hologram: {
        metadata: {
            ...
            description:
                "Futuristic holographic projections with geometric patterns",
    ...
    /***************************************************************
     **          Journey (WASM) Wallpaper Main Configuration
     ***************************************************************/
    journey: {
        metadata: {
 ...
 *========================================================================**/
export const getWallpaperMeta = (wallpaperType) => {
    return WALLPAPER_CONFIGS[wallpaperType]?.metadata || null;
};
export const getControlRanges = (wallpaperType) => {
    return WALLPAPER_CONFIGS[wallpaperType]?.controls || null;
};
export const getAllWallpaperTypes = () => {
    return Object.keys(WALLPAPER_CONFIGS);
};
